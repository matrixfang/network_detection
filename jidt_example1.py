...
jarLocation = "/Users/fangwenyi/Projects/infodynamics-dist-1.5/infodynamics.jar"
...
teCalcClass = JPackage("infodynamics.measures.mixed").TransferEntropyCalculatorKraskov1
teCalc = teCalcClass()
